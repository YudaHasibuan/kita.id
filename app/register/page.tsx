  ...
  return (
    <main className="auth-layout">
      <div className="auth-card glass-panel">
        ...
        <div className="flex items-center my-4 space-x-2 w-full">
        ...
        <form action={googleSignIn} className="w-full">
          <button type="submit" className="w-full bg-white text-black font-semibold py-2 px-4 rounded-lg flex items-center justify-center space-x-2 hover:bg-gray-200 transition-colors">
