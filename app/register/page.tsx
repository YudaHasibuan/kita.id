...
export default function RegisterPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#0a0a0a] relative overflow-hidden text-white font-sans">
      ...
      <div className="absolute bottom-[-20%] left-[-10%] w-[600px] h-[600px] rounded-full bg-emerald-600/20 blur-[150px] pointer-events-none" />
      ...
      <div className="w-full max-w-md p-8 relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
        ...
        <div className="backdrop-blur-xl bg-white/[0.03] border border-white/10 p-10 rounded-3xl shadow-[0_0_40px_rgba(0,0,0,0.5)]">
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold tracking-tight mb-2 text-transparent bg-clip-text bg-gradient-to-r from-white to-white/60">Bergabunglah</h1>
            <p className="text-white/50 text-sm">Buat akun untuk memulai perjalanan Anda.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1">
              <label htmlFor="name" className="text-xs font-medium text-white/60 ml-1">Nama Lengkap</label>
              <div className="relative group">
                ...
                <input 
                  ...
                  id="name" 
                  name="name" 
                  className="w-full bg-black/20 border border-white/10 rounded-xl py-3 pl-11 pr-4 text-white placeholder-white/20 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-transparent transition-all"
        ...
        <p className="text-center mt-8 text-white/50 text-sm">
          Sudah punya akun?{' '}
          <Link href="/login" className="text-white hover:text-emerald-400 font-medium transition-colors border-b border-transparent hover:border-emerald-400 pb-0.5">
            Masuk di sini
          </Link>
        </p>
      </div>
